     ...
     pathDrawingModel:(CGPathDrawingMode)model
{
    ...
    [self drawRectangle:rect withRadius:radius 
              lineWidth:lineWidth pathDrawingModel:model];
}
            ...
            pathDrawingModel:(CGPathDrawingMode)model
{
    ...
    [self drawCircleWithCenter:center radius:radius
                     lineWidth:width pathDrawingModel:model];
}
                ...
                color:(UIColor *)color
{
    ...
    [self drawCurveFrom:startPoint to:endPoint
                ...
                lineWidth:(CGFloat)width
{
    ...
    CGContextRef context = UIGraphicsGetCurrentContext();
    CGContextMoveToPoint(context, startPoint.x, startPoint.y);
    CGContextAddQuadCurveToPoint(context, controlPoint.x,
                                 controlPoint.y, endPoint.x, endPoint.y);
    CGContextSetLineWidth(context, w);
                    ...
                    color:(UIColor *)color
{
    ...
    [self drawQuadCurveFrom:startPoint to:endPoint
               controlPoint:controlPoint lineWidth:width];
}
                ...
                clockWise:(BOOL)clockwise
{
    ...
    [self drawArcFromCenter:center radius:radius
                 startAngle:startAngle endAngle:endAngle
                  lineWidth:width clockWise:clockwise];
}
            ...
            pathDrawingModel:(CGPathDrawingMode)model
{
    ...
    [self drawSectorFromCenter:center radius:radius
                    startAngle:startAngle endAngle:endAngle
                     clockWise:clockWise lineWidth:width
              pathDrawingModel:model];
}
...
-(CGMutablePathRef)pathwithFrame:(CGRect)frame
